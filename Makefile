...
debug:
	...
	cp target/wasm32-unknown-emscripten/debug/space_arcade.wasm web/space_arcade.wasm
	cp target/wasm32-unknown-emscripten/debug/space-arcade.js web/space-arcade.js